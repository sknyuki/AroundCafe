          ...
          <div class="chat-content">
            <div class="chat-left">
              <nav class="chat-sidebar">
                <a>
                  <div
                    ...
                    v-if="
                      !adminQnaLists ||
                      (Array.isArray(adminQnaLists) &&
                        adminQnaLists.length === 0)
                    "
                  >
                    <img
              ...
              <nav class="chat-room">
                ...
                <!-- 채팅방룸 -->
                <ul class="chat-room-msg" v-if="adminQnaLists === null">
                ...
                <ul class="chat-room-msg" v-else>
                  <li
                    v-for="(item, index) in adminQnaLists"
                    :key="index"
                ...
                <div class="chat-normal-wrapper">
                  <div class="chat-normal-header">
                    <div class="avatar-40">
                      ...
                      <img
                        v-if="
                          adminQnaLists[selectQna].received_img != null &&
