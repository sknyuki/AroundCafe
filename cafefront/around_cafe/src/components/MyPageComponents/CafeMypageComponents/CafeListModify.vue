                        ...
                        <v-container>
                            <v-row>
                                <v-col>
                                    ...
                                    <v-text-field label="카페 이름 수정" v-model="mcafe_name"></v-text-field>
                                    <v-text-field label="사업자 번호 수정" v-model="mcafe_bus_no"></v-text-field>
                                    <v-text-field label="영업 시간 수정" v-model="mcafe_time"></v-text-field>
                                    <v-text-field label="카페 설명 수정" v-model="mcafe_content"></v-text-field>
                                    <v-text-field label="연락처 수정" v-model="mcafe_call"></v-text-field>
